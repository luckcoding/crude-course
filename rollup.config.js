...
var banner = '//  @crude/course v' + pkg.version + '\n'
  + '//  And @crude/course under the MIT license.\n';
...
libConfig.output = [
  { sourcemap: true, name: 'Course', file: 'dist/course.cjs.js', format: 'cjs' },
  { sourcemap: true, name: 'Course', file: 'dist/course.es.js', format: 'es' },
];
...
umdFullConfig.output = [
  { globals: globals(), sourcemap: true, name: 'Course', file: 'dist/course.full.js', format: 'umd', banner: banner },
];
...
umdFullConfigMin.output = [
  { globals: globals(), sourcemap: true, name: 'Course', file: 'dist/course.full.min.js', format: 'umd' },
];

const umdConfig = baseUmdConfig(false);
umdConfig.output = [
  { globals: globals(), sourcemap: true, name: 'Course', file: 'dist/course.js', format: 'umd', banner: banner },
];

const umdConfigMin = baseUmdConfig(true);
umdConfigMin.output = [
  { globals: globals(), sourcemap: true, name: 'Course', file: 'dist/course.min.js', format: 'umd' },
];
